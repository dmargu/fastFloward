    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell a Kitty Item" action="kittyItemsMarketSellMarketItem" method="post" fields="itemID price signer"
        >
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
          <text-widget field="price" label="Price" placeholder="10.0"></text-widget>
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"  
          description="Buy a Kitty Item from the marketplace" 
          action="kittyItemsMarketBuyMarketItem" method="post" fields="itemID marketCollectionAddress signer"
        >
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read an addresses sale collection IDs" 
